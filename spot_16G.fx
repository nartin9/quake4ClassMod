effect effects/fire/spot_16G
{
	...
	emitter "fire2G"
	{
		...
		sprite
		{
			duration	0.75,1.25
			blend	add
			material	"gfx/effects/fire/fire2G"  // NEW BRC
			gravity		-0.05,-0.05
	...
	emitter "fire3G"
	{
		...
		sprite
		{
			duration	0.75,1.25
			blend	add
			material	"gfx/effects/fire/fire3G"  // NEW BRC
			gravity		-0.05,-0.05
	...
	emitter "fire5G"
	{
		...
		sprite
		{
			duration	0.75,1.25
			blend	add
			material	"gfx/effects/fire/fire5G"  // NEW BRC
			gravity		-0.05,-0.05
	...
	emitter "embers"
	{
		...
		sprite
		{
			duration	1.5,3
			blend	add
			material	"gfx/effects/energy_sparks/spark3G" //NEW BRC
			gravity		-0.1,0
	...
	spawner "strip"
	{
		...
		sprite
		{
			duration	1,1
			blend	add
			material	"gfx/effects/fire/flame3G" // NEW BRC
	...
	emitter "unnamed11"
	{
		...
		oriented
		{
			duration	1,1
			blend	add
			material	"gfx/effects/fire/fire1G" // NEW BRC
